...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 w-full">
        <div className="grid lg:grid-cols-[55%_45%] gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              {stats.map((stat, index) => (
                ...
                >
                  <span className="text-[clamp(1.5rem,4vw,2.5rem)] font-bold text-foreground">
                    {stat.value}
                  </span>
          ...
          >
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden bg-surface">
              ...
              <div 
                className="absolute inset-0 bg-gradient-to-br from-border to-surface flex items-center justify-center"
                role="img"
